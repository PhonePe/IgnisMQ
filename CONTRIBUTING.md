# Contributing to IgnisMQ

Thank you for considering contributing to IgnisMQ! This guide explains the process for contributing to this project.
...
2. **Clone** your fork locally:
   ```bash
   git clone https://github.com/<your-username>/ignisMQ.git
   cd ignisMQ
   ```
3. **Add the upstream remote:**
   ```bash
   git remote add upstream https://github.com/PhonePe/ignisMQ.git
   ```
...
- Use [GitHub Issues](https://github.com/PhonePe/ignisMQ/issues) to report bugs or request features.
- Include:
  - A clear title and description
  - Steps to reproduce (for bugs)
  - Expected vs. actual behavior
  - IgnisMQ version, Java version, and backend version
  - Relevant logs or stack traces

## License

By contributing to IgnisMQ, you agree that your contributions will be licensed under the [Apache License 2.0](LICENSE).
